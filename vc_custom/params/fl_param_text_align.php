<?php
    ...
    if ( function_exists( 'vc_add_shortcode_param' ) ) {
        ...
        vc_add_shortcode_param( 'tmreviews_align_text', 'tmreviews_align_text_settings_field', TMREVIEWS_THEME_HELPER_ROOT_DIR . '/assets/params/js/fl-custom-params.js');

    }

function tmreviews_align_text_settings_field( $settings, $value ) {
