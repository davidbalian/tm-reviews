<?php
    ...
    if(!class_exists('TMReviews__Helping_Radio_Advanced_Text'))
    {
        class TMReviews__Helping_Radio_Advanced_Text
        {
            function __construct()
            {

                if(function_exists('vc_add_shortcode_param')) {
                    vc_add_shortcode_param('tmreviews_radio_advanced', array($this, 'tmreviews_radio_settings_field'), TMREVIEWS_THEME_HELPER_ROOT_DIR . '/assets/params/js/fl-param_radio-advanced.js');
                }
        ...
        function tmreviews_radio_settings_field($settings, $value){
            $output = '';
    ...
    if(class_exists('TMReviews__Helping_Radio_Advanced_Text'))
    {
        $TMReviews__Helping_Radio_Advanced_Text = new TMReviews__Helping_Radio_Advanced_Text();
    }
