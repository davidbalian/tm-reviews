...
if ( ! defined( 'ABSPATH' ) ) { exit; }
    ...
    if ( function_exists( 'vc_add_shortcode_param' ) ) {
        ...
        vc_add_shortcode_param( 'tmreviews_image_select', 'tmreviews_image_select_settings_field', TMREVIEWS_THEME_HELPER_ROOT_DIR . '/assets/params/js/fl-custom-params.js');
    }


if(!class_exists('tmreviews_image_select_settings_field')) {

    function tmreviews_image_select_settings_field( $settings, $value ) {
