...
if ( function_exists( 'vc_add_shortcode_param' ) ) {
    ...
    vc_add_shortcode_param( 'tmreviews_number', 'tmreviews_number_settings_field');
}

if ( ! function_exists( 'tmreviews_number_settings_field' ) ) :
    function tmreviews_number_settings_field($settings, $value) {

            $suffix             = isset($settings['suffix']) ? $settings['suffix'] : '';
            $suffix_div_open    = isset($settings['suffix']) ? '<div class="tmreviews_number_suffix">' : '';
            $suffix_div_close   = isset($settings['suffix']) ? '</div>' : '';
            $div_suffix         = isset($settings['suffix']) ? 'tmreviews_number_with_suffix' : '';
