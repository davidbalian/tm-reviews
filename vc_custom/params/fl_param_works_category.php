<?php
    if ( function_exists( 'vc_add_shortcode_param' ) ) {
        ...
        vc_add_shortcode_param( 'tmreviews_custom_works_categories', 'tmreviews_custom_works_category_settings_field');

    }

if ( ! function_exists( 'tmreviews_custom_works_category' ) ) :
    function tmreviews_custom_works_category_settings_field( $settings, $value ) {
