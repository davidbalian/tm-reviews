<?php
    if ( function_exists( 'vc_add_shortcode_param' ) ) {
        ...
        vc_add_shortcode_param( 'tmreviews_slider', 'tmreviews_slider_settings_field', TMREVIEWS_THEME_HELPER_ROOT_DIR . '/assets/params/js/fl-custom-params.js');
    }

function tmreviews_slider_settings_field( $settings, $value ) {
    $defaults = array(
        'min'        => 0,
        'max'        => 100,
        'step'       => 1,
