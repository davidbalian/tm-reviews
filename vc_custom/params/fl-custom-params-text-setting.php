<?php
    ...
    if(!class_exists('TMReviews__Helping_Text_Setting'))
    {
        class TMReviews__Helping_Text_Setting
        {
            function __construct()
            {
                if(function_exists('vc_add_shortcode_param'))
                {
                    vc_add_shortcode_param( 'tmreviews_font_setting', array( $this, 'tmreviews_font_setting_form_field' ), TMREVIEWS_THEME_HELPER_ROOT_DIR . '/assets/params/js/fl-param_text_setting.js');
                }
             ...
             * @return mixed|void
             */
            function tmreviews_font_setting_form_field( $settings, $value ) {
                $font_container = new TMReviews__Helping_Text_Setting();
            ...
            public function render( $settings, $value ) {
                $fields = array();
                $values = array();
                extract( $this->_tmreviews_font_setting_parse_attributes( $settings['settings']['fields'], $value ) );
                ...
                <div class="vc_col-sm-6 vc_column-with-padding">
                    <div class="wpb_element_label">' . esc_html__( 'Font size', 'tmreviews_font_setting_form_field' ) . '</div>
                    <div class="crum-number-field-wrap vc_font_container_form_field-font_size-container">
                        <input type="number" min="0" step="1" class="tmreviews_number_field wpb_vc_param_value vc_font_container_form_field-font_size-input tmreviews_number_with_suffix" value="' . $values['font_size'] . '" />
                        <div class="tmreviews_number_suffix">px</div>
                    </div>';
                    ...
                    if ( isset( $fields['line_height'] ) ) {
                        $data['line_height'] = '
                <div class="vc_col-sm-6 vc_column-with-padding">
                    <div class="wpb_element_label">' . esc_html__( 'Line height', 'tmreviews_font_setting_form_field' ) . '</div>
                    <div class="crum-number-field-wrap vc_font_container_form_field-line_height-container">
                        <input type="number" step="1" min="0" class="tmreviews_number_field vc_font_container_form_field-line_height-input wpb_vc_param_value tmreviews_number_with_suffix"  value="' . $values['line_height'] . '" />
                        <div class="tmreviews_number_suffix">px</div>
                    </div>';
                    ...
                    if ( isset( $fields['letter_spacing'] ) ) {
                        $data['letter_spacing'] = '
                <div class="vc_col-sm-6 vc_column-with-padding">
                    <div class="wpb_element_label">' . esc_html__( 'Letter spacing', 'tmreviews_font_setting_form_field' ) . '</div>
                    <div class="crum-number-field-wrap vc_font_container_form_field-letter_spacing-container">
                        <input type="number" min="0" step="1" class="tmreviews_number_field vc_font_container_form_field-letter_spacing-input wpb_vc_param_value tmreviews_number_with_suffix" value="' . $values['letter_spacing'] . '" />
                        <div class="tmreviews_number_suffix">px</div>
                    </div>';
                    ...
                    if ( isset( $fields['font_style'] ) ) {
                        ...
                        $data['font_style'] .= '<div class="wpb_element_label">' . esc_html__( 'Font style', 'tmreviews_font_setting_form_field' ) . '</div>';
                        ...
                        if(isset($values['font_style_italic'])){
                            ...
                            $data['font_style'] .= '<span class="vc_font_container_form_field-font_style-label italic"> ' . esc_html__( 'Italic', 'tmreviews_font_setting_form_field' ) . '</span>';
                        ...
                        if(isset($values['font_style_bold'])){
                            ...
                            $data['font_style'] .= '<span class="vc_font_container_form_field-font_style-label bold"> ' . esc_html__( 'Bold', 'tmreviews_font_setting_form_field' ) . '</span>';
                            $data['font_style'] .= '</label>';
                        }
                        ...
                        if(isset($values['font_style_underline'])){
                            ...
                            $data['font_style'] .= '<span class="vc_font_container_form_field-font_style-label underline">' . esc_html__( 'Underline', 'tmreviews_font_setting_form_field' ) . '</span>';
                            $data['font_style'] .= '</label>';
                        }
             ...
             * @return array
             */
            public function _tmreviews_font_setting_parse_attributes( $attr, $value ) {
                $fields = array();
                if ( isset( $attr ) ) {
    ...
    if(class_exists('TMReviews__Helping_Text_Setting'))
    {
        $TMReviews__Helping_Text_Setting = new TMReviews__Helping_Text_Setting();
    }
