...
if ( function_exists( 'vc_add_shortcode_param' ) ) {
    vc_add_shortcode_param( 'tmreviews_custom_switch_option', 'tmreviews_custom_switch_option_settings_field', TMREVIEWS_THEME_HELPER_ROOT_DIR . '/assets/params/js/fl-custom-params.js');
}

    function tmreviews_custom_switch_option_settings_field( $settings, $value ) {
