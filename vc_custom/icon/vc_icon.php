...
add_action('vc_base_register_front_css', 'tmreviews_helping_vc_iconpicker_base_register_css');
add_action('vc_base_register_admin_css', 'tmreviews_helping_vc_iconpicker_base_register_css');

if (!function_exists('tmreviews_helping_vc_iconpicker_base_register_css')) {
	function tmreviews_helping_vc_iconpicker_base_register_css()
	{
        ...
        wp_register_style('flgazek', plugin_dir_url(__FILE__) . 'icon_assets/css/places_styles.css');
	}
}


add_action('vc_backend_editor_enqueue_js_css', 'tmreviews_helping_vc_iconpicker_editor_jscss');
add_action('vc_frontend_editor_enqueue_js_css', 'tmreviews_helping_vc_iconpicker_editor_jscss');

if (!function_exists('tmreviews_helping_vc_iconpicker_editor_jscss')) {
	function tmreviews_helping_vc_iconpicker_editor_jscss()
	{
        ...
        wp_enqueue_style('flgazek');
    }
}


add_action('vc_enqueue_font_icon_element', 'tmreviews_helping_enqueue_font_elusive');
if (!function_exists('tmreviews_helping_enqueue_font_elusive')) {
	function tmreviews_helping_enqueue_font_elusive($font)
	{
		switch ($font) {
			case 'elusive':
				wp_enqueue_style('elusive');
...
add_filter('vc_iconpicker-type-flgazek', 'vc_iconpicker_type_flgazek');
if (!function_exists('vc_iconpicker_type_flgazek')) {
    function vc_iconpicker_type_flgazek($icons)
    {
        $flgazek_icons = array(
            array(
                array('gazek-icon-clock-with-clockwise'             => 'gazek-icon-clock-with-clockwise'),
                array('gazek-icon-closed-book'                      => 'gazek-icon-closed-book'),
                array('gazek-icon-computer-mouse-with-long-cable'   => 'gazek-icon-computer-mouse-with-long-cable'),
                array('gazek-icon-curriculum-with-picture'          => 'gazek-icon-curriculum-with-picture'),
                array('gazek-icon-desk-lamp-facing-left'            => 'gazek-icon-desk-lamp-facing-left'),
                array('gazek-icon-diagram-scheme'                   => 'gazek-icon-diagram-scheme'),
                array('gazek-icon-editor-pencil'                    => 'gazek-icon-editor-pencil'),
                array('gazek-icon-factory-with-chimney'             => 'gazek-icon-factory-with-chimney'),
                array('gazek-icon-filing-cabinet'                   => 'gazek-icon-filing-cabinet'),
                array('gazek-icon-funds'                            => 'gazek-icon-funds'),
                array('gazek-icon-glasses-with-reflection'          => 'gazek-icon-glasses-with-reflection'),
                array('gazek-icon-hand-touching-button'             => 'gazek-icon-hand-touching-button'),
                array('gazek-icon-headphones-with-thin-mic'         => 'gazek-icon-headphones-with-thin-mic'),
                array('gazek-icon-horizontal-tablet-with-line'      => 'gazek-icon-horizontal-tablet-with-line'),
                array('gazek-icon-hot-drink-facing-left'            => 'gazek-icon-hot-drink-facing-left'),
                array('gazek-icon-inclined-clip'                    => 'gazek-icon-inclined-clip'),
                array('gazek-icon-inclined-compass'                 => 'gazek-icon-inclined-compass'),
                array('gazek-icon-inclined-key'                     => 'gazek-icon-inclined-key'),
                array('gazek-icon-inclined-label'                   => 'gazek-icon-inclined-label'),
                array('gazek-icon-inclined-magnifying-glass'        => 'gazek-icon-inclined-magnifying-glass'),
                array('gazek-icon-inclined-paper-plane'             => 'gazek-icon-inclined-paper-plane'),
                array('gazek-icon-inclined-pen'                     => 'gazek-icon-inclined-pen'),
                array('gazek-icon-inclined-pin'                     => 'gazek-icon-inclined-pin'),
                array('gazek-icon-inclined-rocket'                  => 'gazek-icon-inclined-rocket'),
                array('gazek-icon-letter-and-envelope'              => 'gazek-icon-letter-and-envelope'),
                array('gazek-icon-line-stats'                       => 'gazek-icon-line-stats'),
                array('gazek-icon-list-with-text'                   => 'gazek-icon-list-with-text'),
                array('gazek-icon-long-tie'                         => 'gazek-icon-long-tie'),
                array('gazek-icon-mathematic-calculator'            => 'gazek-icon-mathematic-calculator'),
                array('gazek-icon-megaphone-facing-right'           => 'gazek-icon-megaphone-facing-right'),
                array('gazek-icon-month-calendar'                   => 'gazek-icon-month-calendar'),
                array('gazek-icon-networking-group'                 => 'gazek-icon-networking-group'),
                array('gazek-icon-offering-left-hand'               => 'gazek-icon-offering-left-hand'),
                array('gazek-icon-open-book-with-bookmark'          => 'gazek-icon-open-book-with-bookmark'),
                array('gazek-icon-open-laptop'                      => 'gazek-icon-open-laptop'),
                array('gazek-icon-package-with-parachute'           => 'gazek-icon-package-with-parachute'),
                array('gazek-icon-padlock-closed'                   => 'gazek-icon-padlock-closed'),
                array('gazek-icon-pc-tower-and-monitor'             => 'gazek-icon-pc-tower-and-monitor'),
                array('gazek-icon-pen-and-paper'                    => 'gazek-icon-pen-and-paper'),
                array('gazek-icon-phone-on-circle'                  => 'gazek-icon-phone-on-circle'),
                array('gazek-icon-piggy-bank-with-coin'             => 'gazek-icon-piggy-bank-with-coin'),
                array('gazek-icon-plane-facing-right'               => 'gazek-icon-plane-facing-right'),
                array('gazek-icon-projector-screen'                 => 'gazek-icon-projector-screen'),
                array('gazek-icon-public-speech'                    => 'gazek-icon-public-speech'),
                array('gazek-icon-quality-badge'                    => 'gazek-icon-quality-badge'),
                array('gazek-icon-repair-tools'                     => 'gazek-icon-repair-tools'),
                array('gazek-icon-screen-with-at'                   => 'gazek-icon-screen-with-at'),
                array('gazek-icon-shopping-bag-open'                => 'gazek-icon-shopping-bag-open'),
                array('gazek-icon-shop-with-sign'                   => 'gazek-icon-shop-with-sign'),
                array('gazek-icon-speech-bubble-with-text'          => 'gazek-icon-speech-bubble-with-text'),
                array('gazek-icon-teacher-briefcase'                => 'gazek-icon-teacher-briefcase'),
                array('gazek-icon-three-bars'                       => 'gazek-icon-three-bars'),
                array('gazek-icon-three-binders'                    => 'gazek-icon-three-binders'),
                array('gazek-icon-truck-facing-right'               => 'gazek-icon-truck-facing-right'),
                array('gazek-icon-two-contacts'                     => 'gazek-icon-two-contacts'),
                array('gazek-icon-two-gears'                        => 'gazek-icon-two-gears'),
                array('gazek-icon-two-money-cards'                  => 'gazek-icon-two-money-cards'),
                array('gazek-icon-wallet-closed'                    => 'gazek-icon-wallet-closed'),
                array('gazek-icon-web-home'                         => 'gazek-icon-web-home'),
                array('gazek-icon-world-globe'                      => 'gazek-icon-world-globe'),
                array('gazek-icon-you-are-here'                     => 'gazek-icon-you-are-here'),
                array('gazek-icon-abacus-with-stand'                => 'gazek-icon-abacus-with-stand'),
                array('gazek-icon-appointment-book'                 => 'gazek-icon-appointment-book'),
                array('gazek-icon-bank-safe-box'                    => 'gazek-icon-bank-safe-box'),
                array('gazek-icon-bank-sign'                        => 'gazek-icon-bank-sign'),
                array('gazek-icon-big-cart'                         => 'gazek-icon-big-cart'),
                array('gazek-icon-big-cloud'                        => 'gazek-icon-big-cloud'),
                array('gazek-icon-big-envelope'                     => 'gazek-icon-big-envelope'),
                array('gazek-icon-big-invoice'                      => 'gazek-icon-big-invoice'),
                array('gazek-icon-big-lifesaver'                    => 'gazek-icon-big-lifesaver'),
                array('gazek-icon-big-light'                        => 'gazek-icon-big-light'),
                array('gazek-icon-big-telephone'                    => 'gazek-icon-big-telephone'),
                array('gazek-icon-big-towers'                       => 'gazek-icon-big-towers'),
                array('gazek-icon-browser-with-text-lines'          => 'gazek-icon-browser-with-text-lines'),
                array('gazek-icon-building-with-big-windows'        => 'gazek-icon-building-with-big-windows'),
                array('gazek-icon-business-cards'                   => 'gazek-icon-business-cards'),
                array('gazek-icon-cactus-in-a-pot'                  => 'gazek-icon-cactus-in-a-pot'),
                array('gazek-icon-cart-facing-left'                 => 'gazek-icon-cart-facing-left'),
                array('gazek-icon-chair-with-wheels'                => 'gazek-icon-chair-with-wheels'),
                array('gazek-icon-clipboard-with-blank-paper'       => 'gazek-icon-clipboard-with-blank-paper'),
            ),
        );
        return array_merge($icons, $flgazek_icons);
    }
}
