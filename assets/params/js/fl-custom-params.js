...
( function( $ ) {
    ...
    $('.reviews_style, .places_style').bind('change keyup', function(e) {
        $(this).parent().parent().parent().find('.tmreviews_image_preview_select option').removeAttr("selected");
        $(this).parent().parent().parent().find('.preview-image-hide').hide();
        var current_selected = $(this).val();
        if(current_selected){
            $(this).parent().parent().parent().find('.tmreviews_img_preview .'+current_selected).show();
            $(this).parent().parent().parent().find('.tmreviews_image_preview_select option[class="'+current_selected+'"]').attr('selected', 'selected');
        }
    });
