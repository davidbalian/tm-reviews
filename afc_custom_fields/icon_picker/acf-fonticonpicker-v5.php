...
*/
if ( ! class_exists( 'tmreviews_helping_acf_field_fonticonpicker' ) ) :
class tmreviews_helping_acf_field_fonticonpicker extends acf_field {
...
new tmreviews_helping_acf_field_fonticonpicker();
