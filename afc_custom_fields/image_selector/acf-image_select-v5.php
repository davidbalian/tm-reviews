...
class tmreviews_acf_field_image_select extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Image Select', 'tm-reviews');
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'tm-reviews'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Choices','tm-reviews'),
			'instructions'	=> __('Enter your choices one per line <br /> Red <br /> Blue <br /> red : Red <br /> blue : Blue <br /><span style="color:#BC0B0B">Please note:</span> The first value of each choices will used as name of image.<br />Like for "<strong>Blue</strong>" or "<strong>blue : Blue</strong>", the image name will be "<strong>blue.png</strong>"','tm-reviews'),
			'type'			=> 'textarea',
			'name'			=> 'choices',
		));

		acf_render_field_setting( $field, array(
			'label'			=> __('Default Value','tm-reviews'),
			'type'			=> 'text',
			'name'			=> 'default_value',
		));

		acf_render_field_setting( $field, array(
			'label'			=> __('Allow Multiple Choices?','tm-reviews'),
			'type'			=> 'radio',
			'choices'	=>	array(
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Image Path','tm-reviews'),
			'instructions'	=> __('Enter folder URL for images <b>based on current theme</b>.','tm-reviews'),
			'type'			=> 'text',
			'name'			=> 'image_path',
		));

		acf_render_field_setting( $field, array(
			'label'			=> __('Image Extension','tm-reviews'),
			'type'			=> 'text',
...
// create field
new tmreviews_acf_field_image_select();
