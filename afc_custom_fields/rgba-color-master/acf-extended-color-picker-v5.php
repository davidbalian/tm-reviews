...
if ( ! class_exists( 'tmreviews_helping_acf_field_extended_color_picker' ) ) :

	class tmreviews_helping_acf_field_extended_color_picker extends acf_field {
		...
		*/
		...
		public function __construct() {
			...
			$this->label    = esc_html__('RGBA Color Picker', 'tm-reviews');
            $this->category = "Basic";
			$this->defaults = [
				'default_value' => '',
			];
		...
		public function input_admin_enqueue_scripts() {
			...
			if ( ! isset( $wp_scripts->registered['iris'] ) ) {
				...
				wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', [
					'clear'         => esc_html__('Clear', 'tm-reviews'),
					'defaultString' => esc_html__('Default', 'tm-reviews'),
					'pick'          => esc_html__('Select Color', 'tm-reviews'),
					'current'       => esc_html__('Current Color', 'tm-reviews'),
				] );
		...
		*/
		...
		public function render_field_settings( $field ) {
			...
			acf_render_field_setting( $field, [
				'label'        => esc_html__('Default Value', 'tm-reviews'),
				'instructions' => '',
				'type'         => 'text',
				'name'         => 'default_value',
				'placeholder'  => '#FFFFFF'
...
// initialize
	acf_register_field_type( new tmreviews_helping_acf_field_extended_color_picker() );
